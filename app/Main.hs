...
main = do
    ...
    let my_judge_result = judge my_counted_suits my_counted_numbers $ my_inithand ++ com_card_after_river
    let com1_judge_result = judge com1_counted_suits com1_counted_numbers $ com1_inithand ++ com_card_after_river
    let com2_judge_result = judge com2_counted_suits com2_counted_numbers $ com2_inithand ++ com_card_after_river
    let com3_judge_result = judge com3_counted_suits com3_counted_numbers $ com3_inithand ++ com_card_after_river
    print ((if head after_river_bet_list /= -1 then "you: " ++ all_hand !! fst my_judge_result else "you folded") ++ " com1: " ++ all_hand !! fst com1_judge_result ++ " com2: " ++ all_hand !! fst com2_judge_result ++ " com3: " ++ all_hand !! fst com3_judge_result)